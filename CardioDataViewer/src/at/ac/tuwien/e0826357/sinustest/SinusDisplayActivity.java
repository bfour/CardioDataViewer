...
import at.ac.tuwien.e0826357.sinustest.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class SinusDisplayActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sinus_display);
		...
		LineAndPointFormatter formatter1 = new LineAndPointFormatter(Color.rgb(
	...
	class SampleDynamicXYDatasource implements Runnable {
		...
		private static final int MIN_AMP_SEED = 100;
		...
		public void run() {
			try {
				...
				while (keepRunning) {
					...
					Thread.sleep(10); // decrease or remove to speed up the
										// refresh rate.
					phase++;
